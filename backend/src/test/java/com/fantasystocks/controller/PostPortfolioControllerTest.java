...
public class PostPortfolioControllerTest extends EasyMockSupport {
    @TestSubject
    private PostPortfolioController postPortfolioController = new PostPortfolioController();
    @Mock
    ...
    public void setupAutowiredMocks() {
        ReflectionTestUtils.setField(postPortfolioController, "portfolioService", portfolioService);
    }
    ...
    public void postPortfolioTest() {
        ...
        Object out = postPortfolioController.postPortfolio(input, httpServletRequest, httpServletResponse, portfolioIdTest);
        assertNotNull(out);
    }
